...
%% ========== ALIGN CYLINDER ON TOP OF CUBE ========================
% Here:
%   - Body A = cube
%   - Body B = cylinder
%
% We:
%   1) Align XY so cylinder axis passes through cube centre
%   2) Put the cylinder bottom face flush with the cube top face

[VB, cylShift] = placeCylinderOnCube(VB, VA);

if doDebugPrints
    fprintf('Cylinder translated by [%.4f  %.4f  %.4f]\n', cylShift);
end
